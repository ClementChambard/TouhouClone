...
void effectSpellcardRingP1(AnimScript* anm)
{
    ...
    } else if (anm->frame == 80 + spellcardDuration)
        anm->alpha_time(20, 0, 0);
    else if (anm->frame == 100 + spellcardDuration)
        anm->destroy();
}
...
void effectSpellcardRing(AnimScript* anm)
{
    ...
    } else if (anm->frame == 101 + spellcardDuration)
        anm->destroy();
}
...
void effectBase1(AnimScript* anm)
{
    if (anm->frame == 0 || anm->frame == 16) {
        ...
        anm->scale_time(4, 4, 0.5f, 0.5f);
    else if (anm->frame == 8)
        anm->scale_time(4, 1, 0.75f, 0.75f);
    else if (anm->frame == 12)
        anm->scale_time(4, 4, 1, 1);
    else if (anm->frame == 24)
        anm->destroy();
}
...
void effectExplodeNeg1(AnimScript* anm)
{
    if (anm->frame == 0) {
        ...
        AnmManager::anim(a)->set_pos(-32, 0, 0);
        AnmManager::anim(a)->pos_time(20, 2, 0, 0, 0);
    } else if (anm->frame == 25)
        anm->create_child(effectExplodeNegP);
    else if (anm->frame == 75)
        anm->destroy();
}
...
void effectExplodeEnemy(float x, float y, float a, char colors)
{
    ...
    if (colors & 0b00000001)
        createeffexplode(x, y, a, 0);
    if (colors & 0b00000010)
        createeffexplode(x, y, a, 2);
    if (colors & 0b00000100)
        createeffexplode(x, y, a, 3);
    if (colors & 0b00001000)
        createeffexplode(x, y, a, 1);
    if (colors & 0b00010000)
        createeffexplode(x, y, a, 4);
    if (colors & 0b00100000)
        createeffexplode(x, y, a, 6);
    if (colors & 0b01000000)
        createeffexplode(x, y, a, 7);
    if (colors & 0b10000000)
        createeffexplode(x, y, a, 5);
}
...
void effectExplodeMapleBigP(AnimScript* anm)
{
    if (anm->frame == 0) {
        ...
        anm->set_scale(F0, F0);
        F0 = Random::Angle();
        float F1 = Random::Floatm11() * 128 + 192;
...
void effectSlow1(AnimScript* anm)
{
    ...
    } else if (anm->frame == 18)
        anm->rot_vel(0.0f, 0.0f, 0.10471976f);
    else if (anm->frame == 19)
        anm->frame = 18;
...
void effectSlow2(AnimScript* anm)
{
    if (anm->frame == 0) {
        ...
        anm->rot_vel(0.0f, 0.0f, -0.05235988f);
    else if (anm->frame == 19)
        anm->frame = 18;
    else if (anm->frame == 28)
        anm->destroy();
...
void effectMaple(float x, float y, float s, char type, int r1, int g1, int b1, int r2, int g2, int b2)
{
...
void effectMaple3D1(AnimScript* anm)
{
    ...
    } else if (anm->frame == 200)
        anm->alpha_time(100, 0, 0);
    else if (anm->frame == 300)
        anm->destroy();
}
void effectMaple3D2(AnimScript* anm)
{
    ...
    } else if (anm->frame == 400)
        anm->alpha_time(100, 0, 0);
    else if (anm->frame == 500)
        anm->destroy();
}
...
{
    caura1 = auracolors[(2 * i) % 16];
    caura2 = auracolors[(2 * i + 1) % 16];
}
...
void effectAura(AnimScript* anm)
{
    if (anm->frame == 0 || anm->frame == 6) {
        ...
        anm->create_child(effectAuraP2);
    else if (anm->frame == 4)
        anm->create_child(effectAuraP3);
    else if (anm->frame == 37)
        anm->destroy();
    if (anm->interrupt == 1)
        anm->frame = 7;
}
...
void effectAura3Dleaf1(AnimScript* anm)
{
    if (anm->frame == 0) {
        ...
        p.x += F3;
        F3 = Random::Floatm11() * 200.0f;
        p.y += F3 - 200.f;
        anm->set_alpha(0);
        anm->alpha_time(30, 0, 64);
        anm->set_pos(p.x, p.y, p.z);
        F3 = Random::Floatm11() * 50.0f;
        p.x += F3;
        F3 = Random::Floatm11() * 60.0f;
        p.y += F3 + 160.f;
...
void effectBreakWave(float a, float x, float y, float s, int r, int g, int b, int n)
{
    ...
    for (int i = 0; i < n; i++) {
        ...
        float rr = Random::Float01() * 16;
        float aa = Random::Angle();
        float xx = math::lengthdir_y(rr, aa);
        float yy = math::lengthdir_y(rr, aa);
...
void effectSplash(AnimScript* anm)
{
    if (anm->frame == 0) {
        ...
        anm->set_sprite(spr54);
    else if (anm->frame == 4)
        anm->set_sprite(spr55);
    else if (anm->frame == 6)
        anm->set_sprite(spr56);
    else if (anm->frame == 8)
        anm->set_sprite(spr57);
    else if (anm->frame == 10)
        anm->set_sprite(spr58);
    else if (anm->frame == 12)
        anm->set_sprite(spr59);
    else if (anm->frame == 14)
        anm->set_sprite(spr60);
    else if (anm->frame == 16)
        anm->set_sprite(spr61);
    else if (anm->frame == 18)
        anm->destroy();
}
...
void effectChargeP1(AnimScript* anm)
{
    if (anm->frame == 0) {
        ...
        if (rand() % 32 == 0)
            anm->set_layer(GL_ L11);
        anm->set_blendmode(2);
        anm->set_sprite(spr62);
        anm->set_scale(.6, .6);
        anm->set_pos(Random::Floatm11() * 50, -300 + Random::Floatm11() * 50, 0);
    } else if (anm->frame == anm->z_())
        anm->x_time(anm->z_(), 1, Random::Floatm11() * 20);
    else if (anm->frame == 2 * anm->z_() + 10)
        anm->alpha_time(10, 0, 0);
    else if (anm->frame == 2 * anm->z_() + 20)
        anm->destroy();
    if (anm->interrupt == 1) {
