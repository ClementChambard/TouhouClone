...
void asciiCardnameBg(AnimScript* anm)
{
    ...
    if (anm->frame == 0) {
        ...
        anm->pos_time(60, 10, xx, yy + 384.f, 0);
    else if (anm->frame == 61)
        anm->frame = 60;
    else if (anm->frame == 91)
        anm->destroy();
    if (anm->interrupt == 3)
        anm->alpha_time(8, 1, 128);
    else if (anm->interrupt == 2)
        anm->alpha_time(8, 1, 255);
...
void asciiCardHistory(AnimScript* anm)
{
    ...
    if (anm->frame == 0) {
        ...
        anm->frame = 90;
    else if (anm->frame == 121)
        anm->destroy();
    if (anm->interrupt == 3)
        anm->alpha_time(8, 1, 32);
    else if (anm->interrupt == 2)
        anm->alpha_time(8, 1, 255);
    else if (anm->interrupt == 1) {
...
void asciiNum1(AnimScript* anm)
{
    ...
    else if (anm->frame == 141)
        anm->alpha_time(20, 0, 0);
    else if (anm->frame == 171)
        anm->destroy();
    if (anm->interrupt == 2) {
        anm->pos_time(60, 9, -112, 189, 0);
        anm->set_color(255, 255, 255);
    } // 51
    else if (anm->interrupt == 3) {
        anm->pos_time(60, 9, -112, 217, 0);
        anm->set_color(255, 255, 255);
    } // 23
    else if (anm->interrupt == 4)
        anm->alpha_time(20, 0, 255);
    else if (anm->interrupt == 5)
        anm->alpha_time(20, 0, 64);
...
void asciiNum2(AnimScript* anm)
{
    if (anm->frame == 0) {
        ...
        anm->destroy();
    if (anm->interrupt == 2) {
        anm->pos_time(60, 9, -100, 189, 0);
        anm->set_color(255, 255, 255);
    } else if (anm->interrupt == 3) {
        anm->pos_time(60, 9, -100, 217, 0);
        anm->set_color(255, 255, 255);
    } else if (anm->interrupt == 4)
        anm->alpha_time(20, 0, 255);
    else if (anm->interrupt == 5)
...
void asciiNum3(AnimScript* anm)
{
    ...
    if (anm->frame == 0) {
        ...
        anm->set_color(255, 255, 255);
    } else if (anm->frame == 32 + f1 || anm->frame == 36 + f1 || anm->frame == 40 + f1 || anm->frame == 44 + f1 || anm->frame == 48 + f1 || anm->frame == 52 + f1)
        anm->set_color(128, 128, 128);
    else if (anm->frame == 34 + f1 || anm->frame == 38 + f1 || anm->frame == 42 + f1 || anm->frame == 46 + f1 || anm->frame == 50 + f1 || anm->frame == 54 + f1)
        anm->set_color(255, 255, 255);
    else if (anm->frame == 54 + f1 + f2)
        anm->scale_time(20, 4, 1, 0);
    else if (anm->frame == 74 + f1 + f2)
        anm->destroy();
}
...
void asciiLoadP1(AnimScript* anm)
{
    if (anm->frame == 0) {
        ...
        anm->set_alpha(0);
        anm->alpha_time(8, 0, 255);
    } else if (anm->frame == 20 || anm->frame == 60) {
        anm->frame = 20;
        anm->alpha_time(20, 9, 255);
    } else if (anm->frame == 40)
        anm->alpha_time(20, 9, 128);
    else if (anm->frame == 91)
        anm->destroy();
    if (anm->interrupt == 1) {
        anm->frame = 61;
...
void asciiLoadP2(AnimScript* anm)
{
    if (anm->frame == 0) {
        ...
        anm->alpha_time(8, 0, 255);
    } else if (anm->frame == 38 || anm->frame == 98) {
        anm->frame = 38;
        anm->alpha_time(30, 9, 255);
    } else if (anm->frame == 68)
        anm->alpha_time(30, 9, 128);
    else if (anm->frame == 129)
        anm->destroy();
    if (anm->interrupt == 1) {
        anm->frame = 99;
...
void asciiLoadP3(AnimScript* anm)
{
    ...
    else if (anm->frame == 120 || anm->frame == 131)
        anm->destroy();
    if (anm->interrupt == 1) {
        anm->frame = 121;
        anm->alpha_time(10, 0, 0);
...
void asciiLoad(AnimScript* anm)
{
    if (anm->frame == 0) {
        ...
        if (anm->frame == 1) {
            anm->create_child(asciiLoadP1);
            anm->create_child(asciiLoadP2);
        }
        anm->frame = 1;
...
void asciiLoadEff(AnimScript* anm)
{
    ...
    } else if (anm->frame == 290 || anm->interrupt == 1) {
        anm->frame = 290;
        anm->alpha_time(10, 0, 0);
